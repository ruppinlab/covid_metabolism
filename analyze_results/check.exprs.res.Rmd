...
rio::export(tmp, "../gem_manuscript/Table S1_SARS-CoV-2-infected compared to control differential expression results for each dataset.xlsx")

tmp <- gsea.res.metab.kegg
names(tmp) <- paste0(names(tmp), "_KEGG_Metabolism")
tmp <- c(gsea.res, tmp)
rio::export(tmp, "../gem_manuscript/Table S2_SARS-CoV-2-infected compared to control GSEA results for each dataset.xlsx")
...
rio::export(tmp, "../gem_manuscript/Table S3_SARS-CoV-2-infected compared to control most consistently altered gene sets from GSEA across datasets.xlsx")
```
