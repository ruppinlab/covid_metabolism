...
```{r}
rio::export(df.res, "../gem_manuscript/Table S4_SARS-CoV-2-infected compared to control differential flux results for each dataset.xlsx")
...
rio::export(tmp, "../gem_manuscript/Table S5_SARS-CoV-2-infected compared to control most consistently altered metabolic fluxes across datasets.xlsx")
```
