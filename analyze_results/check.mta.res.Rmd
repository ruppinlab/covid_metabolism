...
rio::export(tmp, "../gem_manuscript/Table S6_MTA-predicted anti-SARS-CoV-2 metabolic targets based on each dataset and their validations.xlsx")
...
rio::export(tmp, "../gem_manuscript/Table S7_Consensus MTA-predicted anti-SARS-CoV-2 metabolic targets across datasets and their pathway enrichment.xlsx")
```
